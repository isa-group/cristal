 ...
 * Time: 11:52
 */
public class OrExprTest extends AbstractBaseTest {

    @Test
    public void shouldQueryOrs() {
        RALExpr expr = RALParser.parse("HAS ROLE Account Administrator OR HAS ROLE Project Coordinator");
