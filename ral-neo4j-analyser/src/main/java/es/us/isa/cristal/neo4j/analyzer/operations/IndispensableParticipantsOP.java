 ...
 *
 */
public class IndispensableParticipantsOP extends AbstractOP<Set<String>> implements Operation<Set<String>> {

	private Iterable<String> activities;
	
	public IndispensableParticipantsOP(BPEngine bpEngine,
