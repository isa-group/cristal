...
public class MatrixHandler {
	...
	public RaciMatrix loadMatrix(String matrixContent) {
		RaciMatrix matrix = null;
		ObjectMapper mapper = new ObjectMapper();
		try {
			matrix = mapper.readValue(matrixContent, RaciMatrix.class);
	...
	public RaciMatrix loadMatrixFile (String matrixFile)
	{
		RaciMatrix matrix = null;
		ObjectMapper mapper = new ObjectMapper();
		try {
